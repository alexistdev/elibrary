<div>
    ...
    <!-- loader-->
    <link href="{{asset('template/rocker/assets/css/pace.min.css')}}" rel="stylesheet"/>
    <script src="{{asset('template/rocker/assets/js/pace.min.js')}}"></script>
    <!-- Bootstrap CSS -->
    <link href="{{asset('template/rocker/assets/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('template/rocker/assets/css/bootstrap-extended.css')}}" rel="stylesheet">
